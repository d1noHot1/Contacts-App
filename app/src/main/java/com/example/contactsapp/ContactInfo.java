    ...
    protected void onCreate(Bundle savedInstanceState) {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        Backendless.Persistence.of(Contact.class).remove(ApplicationClass.contacts.get(index), new AsyncCallback<Long>() {
                            ...
                            public void handleResponse(Long response) {
                                // ovde je kad izbrise zelimo da izbrisemo iz applicationa taj kontakt;
                                ApplicationClass.contacts.remove(index);


                                Toast.makeText(ContactInfo.this, "Contact sucessfully deleted!", Toast.LENGTH_LONG).show();
                               setResult(RESULT_OK);
                            ...
                            public void handleFault(BackendlessFault fault) {
                                Toast.makeText(ContactInfo.this,"Error: " + fault.getMessage(), Toast.LENGTH_LONG).show();
                                showProgress(false);
                            }
                        });
                    }
        ...
        btnEdit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(ContactInfo.this, "Please enter all fields!", Toast.LENGTH_LONG).show();
                }
                else
                    {
                        ...
                        Backendless.Persistence.save(ApplicationClass.contacts.get(index), new AsyncCallback<Contact>() {
                            ...
                            public void handleResponse(Contact response) {
                                // da promijenimo char i ime nakon promjene

                                tvChar.setText(ApplicationClass.contacts.get(index).getName().toUpperCase().charAt(0) + "");
                                tvName.setText(ApplicationClass.contacts.get(index).getName());


                                Toast.makeText(ContactInfo.this,"Contact sucessfully updated!", Toast.LENGTH_LONG).show();
                                showProgress(false);
                            }
