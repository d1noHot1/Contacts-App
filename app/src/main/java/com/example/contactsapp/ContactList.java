...
public class ContactList extends AppCompatActivity {
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        // Ovaj metod nam pomaze da provjerimo da li je request code = 1;
        super.onActivityResult(requestCode, resultCode, data);
        if (requestCode == 1)
        {
            //na osnovu ovoga znacemo da je povratni kod onaj koji smo poslali;
            adapter.notifyDataSetChanged(); // samo notifikujemo da je promijenjena data;
            // ovo znaci da mozemo da promijenimo ili izbrisemo podatke, i kada se vratimo zelimo
            // da obavijestimo adapter da se promijenila data;
